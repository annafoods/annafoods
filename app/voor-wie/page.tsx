    ...
    <>
      ...
      <section className="bg-beige py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-heading text-[52px] sm:text-[96px] lg:text-[120px] leading-none text-terracotta font-bold mb-10">
            Voor wie
          </h1>

          <div className="border-l-2 border-blue-accent pl-8">
