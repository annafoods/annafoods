...
export default function Navigation() {
  ...
  return (
    <header
      className={`sticky top-0 z-50 bg-beige border-b border-beige-dark transition-shadow duration-200 ${
        scrolled ? 'shadow-sm' : ''
      }`}
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile menu */}
        <div className={`md:hidden overflow-y-auto transition-all duration-300 ${isOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
